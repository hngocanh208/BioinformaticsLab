<footer class="bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 py-8 mt-12 transition-colors duration-200">
        ...
        <div class="md:flex md:items-center md:justify-between">
            ...
            <div class="mt-8 md:mt-0 md:order-1">
                <p class="text-center text-sm text-gray-400 dark:text-gray-500">
                    &copy; {{ date('Y') }} Bioinformatics Lab. All rights reserved.
                </p>
            </div>
        </div>
    </div>
